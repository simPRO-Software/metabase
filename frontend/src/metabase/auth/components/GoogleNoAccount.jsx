    ...
    <div className="wrapper">
      <div className="Login-wrapper Grid  Grid--full md-Grid--1of2">
        ...
        <div className="Grid-cell text-centered bordered rounded shadowed p4">
          <h3 className="mt4 mb2">{t`No Report Builder account exists for this Google account.`}</h3>
          <p className="mb4 ml-auto mr-auto" style={{ maxWidth: 360 }}>
            {t`You'll need an administrator to create a Report Builder account before you can use Google to log in.`}
          </p>
