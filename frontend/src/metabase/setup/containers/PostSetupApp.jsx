                    ...
                    {sampleCandidates && (
                      <Card>
                        <ExplorePane
                          ...
                          title={null}
                          description={t`This seems to be taking a while. In the meantime, you can check out one of these example explorations to see what BI Reporting can do for you.`}
                        />
                      </Card>
                    )}
                  </div>
