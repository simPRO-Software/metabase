      ...
      <p>
        {t`All users belong to the ${getGroupNameLocalized(
          group,
                ...
                make sure you know what new Report Builder users will be able to see.`}
      </p>
    </div>
  ) : isAdminGroup(group) ? (
    <div className="px2 text-measure">
      <p>
        {t`This is a special group whose members can see everything in the Report Builder instance, and who can access and make changes to the
                settings in the Admin Panel, including changing permissions! So, add people to this group with care.`}
      </p>
      <p>
        {t`To make sure you don't get locked out of Report Builder, there always has to be at least one user in this group.`}
      </p>
    </div>
  ) : null;
