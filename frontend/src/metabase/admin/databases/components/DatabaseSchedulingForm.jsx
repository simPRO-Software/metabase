            ...
            <div className="Form-offset mr4 mt4">
              <div style={{ maxWidth: 600 }} className="border-bottom pb2">
                <p className="text-paragraph text-measure">
                  {t`To do some of its magic, Report Builder needs to scan your database. We will also rescan it periodically to keep the metadata up-to-date. You can control when the periodic rescans happen below.`}
                </p>
              </div>
              ...
              <div className="mt4">
                ...
                <p className="text-paragraph text-measure">{t`Report Builder can scan the values present in each
                                    field in this database to enable checkbox filters in dashboards and questions. This
                                    can be a somewhat resource-intensive process, particularly if you have a very large
                                    database.`}</p>

                <h3
                >{t`When should Report Builder automatically scan and cache field values?`}</h3>
                <ol className="bordered shadowed mt3">
                  ...
                  <li className="border-bottom pr2">
                    ...
                    >
                      <p className="text-paragraph text-measure">
                        {t`When a user adds a new filter to a dashboard or a SQL question, Report Builder will
