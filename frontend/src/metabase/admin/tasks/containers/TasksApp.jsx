      ...
      <Box p={3}>
        <Flex align="center">
          <Flex align="center">
            ...
            <Tooltip
              tooltip={t`Trying to get to the bottom of something? This section shows logs of Report Builder's background tasks, which can help shed light on what's going on.`}
            >
              <Icon
                name="info"
                ml={1}
