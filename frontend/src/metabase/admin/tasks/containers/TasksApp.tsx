    ...
    <SectionRoot>
      <SectionHeader>
        <SectionTitle>
          ...
          <Tooltip
            label={t`Trying to get to the bottom of something? This section shows logs of BI Reporting background tasks, which can help shed light on what's going on.`}
          >
            <InfoIcon name="info" />
          </Tooltip>
        </SectionTitle>
