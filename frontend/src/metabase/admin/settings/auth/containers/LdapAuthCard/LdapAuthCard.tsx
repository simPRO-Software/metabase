...
const mapStateToProps = (state: State) => ({
  type: "ldap",
  name: t`LDAP`,
  description: t`Allows users within your LDAP directory to log in to BI Reporting with their LDAP credentials, and allows automatic mapping of LDAP groups to Metabase groups.`,
