...
const mapStateToProps = (state: State): StateProps => ({
  ...
  description: t`Allows users with existing BI Reporting accounts to login with a Google account that matches their email address in addition to their Metabase username and password.`,
