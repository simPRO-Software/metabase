      ...
      <ScheduleOptionList>
        ...
        >
          <ScheduleOptionText>
            ...
            {t`When a user adds a new filter to a dashboard or a SQL question, BI Reporting will scan the field(s) mapped to that filter in order to show the list of selectable values.`}
          </ScheduleOptionText>
        </ScheduleOption>
        <ScheduleOption
